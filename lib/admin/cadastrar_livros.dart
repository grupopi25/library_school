                      ...
                      Row(
                       ...
                       Text(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text("ANO DE PUBLICAÇÃO",style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Color(0xff434655),)),
                        ...
                        Row(spacing: 10, children: [
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),color: const Color(0x1D8C8D91),),child: 
                                Padding(
                                  padding: const EdgeInsets.all(18.0),
                                  child: Center(child: Text("Cancelar",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: Color(0xff191C1E)),)),
                                ),),
                            ),
                          ),
                           Expanded(
                            child: InkWell(
                              child: Container(
                                decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),gradient: LinearGradient(colors: [Color(0xff004AC6), Color(0xff2563EB),],begin: Alignment.topCenter,end: Alignment.bottomCenter)),child: 
                                Padding(
                                  padding: const EdgeInsets.all(18.0),
                                  child: Center(child: Text("Salvar",style: TextStyle( fontWeight: FontWeight.bold,fontSize: 15,color: Colors.white),)),
                                ),),
                            ),
                          ),
